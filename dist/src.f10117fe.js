...
"use strict"; // 룰셋에 관한 정의

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.MinimumLengthLimit = exports.CantStartNumber = exports.CantContainWhitespace = exports.RequireContainAt = exports.RequireRule = void 0;
exports.RequireRule = {
  rule: /.+/,
  match: true,
  message: "필수 입력 항목입니다."
};
exports.RequireContainAt = {
  rule: /^[^@]+$/,
  match: false,
...
function () {
  function TextField(container, data) {
    ...
    this.validate = function () {
      ...
      var invalidateRules = _this.validateRules.filter( // 정규식을 통해 test 메소드로 실행하여 boolean값을 받아옴
      // 아무런 것도 걸리지 않으면 통과
    ...
    this.onChange = function (e) {
      ...
      if (id === _this.data.id) {
        ...
        _this.updated = true; // 최초 아무것도 안했을 경우와 달리 한번이라도 바뀌었으면 update 상태를 true로 바꿈
    ...
    this.container = container;
    this.data = __assign(__assign({}, DefaultProps), data); // 입력 받은 데이터 중 없는 값은 default로, 받은 값은 오버라이드로 업데이트
...
"use strict"; // views template의 하위 클래스 들을 담아 export 해줌 ()
...
function () {
  function App(container, data) {
    ...
    this.initialize = function () {
      ...
      emailField.addValidateRule(constant_1.RequireContainAt);
    ...
    this.render = function () {
      // 템플릿을 데이터에 넣고 html로 변환하여 container에 삽입 => UI 업데이트
    ...
    this.container = document.querySelector(container); // root id를 갖고 있는다.
...
app.render();
},{"./app":"src/app.ts"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
